...
procedure TfMain.InformationClick(Sender: TObject);
begin
 ShowMessage('Программа телефонного справочника позоляет добавлять контакты и номера телефонов и сохранять их в базу');
end;
